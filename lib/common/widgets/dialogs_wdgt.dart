        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 24),
              Text(title, style: getFont(16, color: cWhite)),
              SizedBox(height: 12),
              Text(subtitle, style: getFont(12, color: cWhite)),
            ],
          ),
        ),
      ),
  ...
  static Future<dynamic> showAlertDialogBox(BuildContext context,
    ...
    return showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(title, style: getFont(16, color: cBlack)),
        content: Text(subtitle, style: getFont(12, color: cBlack)),
        actions: [
          Row(
