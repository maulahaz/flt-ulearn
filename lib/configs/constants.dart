...
//--Application names:
const String APP_NAME = 'ULEARNING';
const String APP_DESC = 'Learning Apps'; //'MHzPOS for Abu Rasya';
...
const String BASE_URL =
    "http://10.0.2.2:8000/api/"; // Emulator-Laravel-Localhost
...
const int TIME_OUT_RECEIVE = 30; //--Seconds
